...
public class CommonResult<T> {
     ...
     * 用户状态错误
     */
    public static <T> CommonResult<T> userStatusFailed() {
        return new CommonResult<T>(ResultCode.USERSTATUSERROR.getCode(), ResultCode.USERSTATUSERROR.getMessage(), null);
    }
    /**
     * 未登录返回结果
     */
